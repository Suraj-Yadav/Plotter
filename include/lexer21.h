...
//std::cout<<"["<<peek<<"]";
		switch (*i) {
			case ';' :
				i++;
				t.push_back(Token(Tag::SCOL)); break;
			case '%' :
				i++;
				t.push_back(Token(Tag::REM)); break;
			case '#' :
				i++;
				t.push_back(Token(Tag::HASH)); break;
			case '^' :
				i++;
				t.push_back(Token(Tag::POW)); break;
			case '(' :
				i++;
				if (t.back().tag == Tag::VAR)
					t.back().tag = Tag::FUN;
				t.push_back(Token(Tag::LPAR)); break;
			case ')' :
				i++;
				t.push_back(Token(Tag::RPAR)); break;
			case '{' :
				i++;
				t.push_back(Token(Tag::LBLK)); break;
			case '}' :
				i++;
				t.push_back(Token(Tag::RBLK)); break;
			case '/' :
				i++;
				t.push_back(Token(Tag::DIV)); break;
			case '[' :
				i++;
				t.push_back(Token(Tag::LSQB)); break;
			case ']' :
				i++;
				t.push_back(Token(Tag::RSQB)); break;
			case '+' :
				i++;
				t.push_back(Token(Tag::PLUS)); break;
			case '-' :
				i++;
				t.push_back(Token(Tag::MINUS)); break;
			case '*' :
				i++;
				t.push_back(Token(Tag::MUL)); break;
			case ',' :
				i++;
				t.push_back(Token(Tag::COMM)); break;
			case '&' :
